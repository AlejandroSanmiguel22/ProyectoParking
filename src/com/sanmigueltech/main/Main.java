...
import com.sanmigueltech.component.Message;
import com.sanmigueltech.component.PanelCover;
import com.sanmigueltech.component.PanelLoading;
import com.sanmigueltech.component.PanelLoginAndRegister;
import com.sanmigueltech.component.PanelVerifyCode;
import com.sanmigueltech.connection.DatabaseConnection;
import com.sanmigueltech.model.ModelLogin;
import com.sanmigueltech.model.ModelMessage;
import com.sanmigueltech.model.ModelUser;
import com.sanmigueltech.service.ServiceMail;
import com.sanmigueltech.service.ServiceUser;
...
public class Main extends javax.swing.JFrame {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    if (service.verifyCodeWithUser(user.getUserID(), verifyCode.getInputCode())) {
                        ...
                        showMessage(Message.MessageType.ERROR, "Codigo incorrecto");
                    }
    ...
    private void register() {
        ...
        try {
            if (service.checkDuplicateUser(user.getUserName())) {
                ...
                showMessage(Message.MessageType.ERROR, "El correo electrónico ya existe");
            } else {
 ...
 private void login() {
    ...
    try {
        ...
        if (user != null) {
            this.dispose();
            PanelParking.main(user);

        } else {
            showMessage(Message.MessageType.ERROR, "Correo electrónico y contraseña incorrectos");
        }
    } catch (SQLException e) {
        e.printStackTrace();
        showMessage(Message.MessageType.ERROR, "Error al ingresar");
    }
}
